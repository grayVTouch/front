...
(function(){
    ...
    function PicPreview(selector , option)
    {
        this.dom = {
            root: G(selector)
        };
    ...
    PicPreview.prototype = {
        ...
        show: function(index){
            ...
            var self = this;
            this.dom.picPreview.removeClass('hide');
            this.dom.picPreview.startTransition('show' , function(){
                // 还原之前的，硬性规定
        ...
        hide: function(){
            var self = this;
            this.dom.picPreview.endTransition('show' , function(){
                self.dom.picPreview.addClass('hide');
            })
        } ,
        ...
        initStatic: function(){
            ...
            this.dom.picPreview = G('.pic-preview' , this.dom.root.get(0));
            this.dom.preview = G('.preview' , this.dom.picPreview.get(0));
            ...
            this.dom.sImages = G('.s-images' , this.dom.picPreview.get(0));
            ...
            if (this.option.visibility === 'hidden') {
                this.dom.picPreview.removeClass('show');
                this.dom.picPreview.addClass('hide');
            } else {
                this.dom.picPreview.removeClass('hide');
                this.dom.picPreview.addClass('show');
            }
        } ,
        ...
        switchFullOrNormalScreen: function(status , reset){
            ...
            {
                case 'full':
                    this.dom.picPreview.requestFullScreen();
                    this.dom.fullScreen.addClass('hide');
                    this.dom.normalScreen.removeClass('hide');
                    break;
                case 'normal':
                    this.dom.picPreview.exitFullScreen();
